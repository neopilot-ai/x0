...
export function NewChatButton({ projectId, showText = 'New Chat' }: NewChatButtonProps) {
  ...
  return (
    <button
      ...
      className={`bg-black hover:bg-gray-800 text-white rounded-lg transition-colors duration-200 flex items-center space-x-2 ${isLargeButton ? 'px-6 py-3 mx-auto' : 'px-4 py-2'}`}
    >
      <svg
