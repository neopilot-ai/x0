...
export function createInstructionsManager(config: InstructionsConfig): InstructionsManager {
  ...
  return {
    ...
    validateConfig(config: InstructionsConfig) {
      ...
      if (
        config.framework &&
        !['next.js', 'react', 'vue', 'angular', 'svelte'].includes(config.framework)
      ) {
...
export const INSTRUCTION_TEMPLATES: InstructionTemplate[] = [
  {
    ...
    systemPrompt:
      'Use Next.js 14 with App Router, TypeScript, and Tailwind CSS. Follow the App Router conventions.',
  ...
  },
  {
    ...
    systemPrompt:
      'Create React components using shadcn/ui. Use TypeScript and follow React best practices.',
  ...
  },
  {
    ...
    systemPrompt:
      'Create a full-stack application. Use Next.js for the frontend, Supabase/Neon for the database, and Vercel for deployment.',
  ...
  },
  {
    ...
    systemPrompt:
      'Create a data dashboard with charts, tables, and real-time data. Use Recharts or Chart.js for visualization.',
  ...
  },
  {
    ...
    systemPrompt:
      'Create an e-commerce storefront with product listings, cart, and Stripe payment integration.',
