---
title: Create Chat From Vercel Project
description: Creates a new chat from an existing Vercel project.
badge: 'POST'
---

# Create Chat From Vercel Project

<EndpointDisplay method="post" path="/chats/from-vercel-project" versionPrefix="/v2" />
...
const result = await v0.chats.createFromVercelProject({
vercelProjectId: 'prj_abcdefghijklmnopqrstuvwxyz12',
})
...
language="cURL"
title="cURL Example"
code={`curl -X POST "https://api.v0.dev/v2/chats/from-vercel-project" \
  -H "Authorization: Bearer $V0_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"vercelProjectId":"prj_abcdefghijklmnopqrstuvwxyz12"}'`}
/>
</CustomCodeBlock>
...
"type": "string",
"required": true,
"description": "Vercel project ID in the active user or team scope.",
"deprecated": false
},
{
"name": "baseBranch",
"type": "string",
"required": false,
"description": "Base branch for a GitHub-linked project. Defaults to the repository default branch. Ignored for projects without a GitHub link.",
"deprecated": false
}
]}
/>
