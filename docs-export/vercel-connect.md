...
- **Apps that act as the signed-in user.** *"Build me a dashboard of my open GitHub pull requests."* Each viewer authorizes GitHub themselves and sees their own data.
